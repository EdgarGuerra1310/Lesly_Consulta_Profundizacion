...
La aplicación estará disponible en `http://localhost:8000/asistente_profundizacion`
...
1. **Acceder a la interfaz web**: Abre tu navegador y ve a `http://localhost:8000/asistente_profundizacion`
